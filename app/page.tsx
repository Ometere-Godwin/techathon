...
import { BookOpen, Code2, GraduationCap, Users, Palette, Globe, Calendar, MapPin } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
        ...
        <div className="bg-purple-900 text-white py-3">
          <div className="max-w-6xl mx-auto px-4 text-center">
            <div className="flex flex-col sm:flex-row justify-center items-center gap-2 sm:gap-4">
              <span className="text-base sm:text-lg font-semibold mb-2 sm:mb-0">Registration Closes In:</span>
        ...
        <div className="bg-purple-100 py-2">
          <div className="max-w-6xl mx-auto px-4 text-center">
            <div className="flex items-center justify-center space-x-2 text-purple-900">
              ...
              <span className="font-medium">100% Online Learning - Study from Anywhere in Lagos</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center bg-black/30">
          <div className="text-center px-4">
            ...
            <p className="text-xl md:text-2xl text-white mb-4 max-w-2xl mx-auto">
              Transform your future with Frontend Development or UI/UX Design through our interactive online program. Special offer for Secondary School graduates and JAMB candidates in Lagos.
            </p>
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Button size="lg" className="bg-purple-500 hover:bg-purple-600 text-white px-8 py-6 text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="p-6 text-center feature-card relative">
              <IconWrapper 
                ...
                strokeWidth={1.5} 
              />
              <h3 className="text-xl font-semibold mb-2 feature-title">Practical Learning</h3>
              <p className="text-gray-600">Learn by building real projects with modern technologies</p>
            </Card>
            <Card className="p-6 text-center feature-card relative">
              <IconWrapper 
                icon={Users} 
                ...
                strokeWidth={1.5} 
              />
              <h3 className="text-xl font-semibold mb-2 feature-title">Expert Mentorship</h3>
            ...
            <Card className="p-6 text-center feature-card relative">
              <IconWrapper 
                ...
                strokeWidth={1.5} 
              />
              <h3 className="text-xl font-semibold mb-2 feature-title">Comprehensive Curriculum</h3>
              <p className="text-gray-600">From basics to advanced concepts in both tracks</p>
            </Card>
            <Card className="p-6 text-center feature-card relative">
              <IconWrapper 
                icon={GraduationCap} 
                ...
                strokeWidth={1.5} 
              />
              <h3 className="text-xl font-semibold mb-2 feature-title">Career Ready</h3>
              <p className="text-gray-600">Graduate with a portfolio and job-ready skills</p>
            </Card>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-8">
                <div className="flex items-center mb-6">
                  <IconWrapper icon={Code2} className="w-8 h-8 text-purple-600 mr-3" />
                  <h3 className="text-2xl font-bold text-purple-900">Frontend Development Track</h3>
                </div>
                <div className="space-y-6">
                  <div>
                    <h4 className="text-xl font-semibold text-purple-900 mb-2">Course Duration</h4>
                    <p className="text-gray-700">3 months intensive training</p>
                    <p className="text-purple-600 mt-1">
                      <IconWrapper icon={Globe} className="inline-block w-4 h-4 mr-1" />
                      Fully Online - Live Interactive Sessions
                    </p>
                  </div>
                  <div>
                    <h4 className="text-xl font-semibold text-purple-900 mb-2">What You'll Learn</h4>
                  ...
                  <div>
                    <h4 className="text-xl font-semibold text-purple-900 mb-2">Career Outcomes</h4>
                    <ul className="list-disc list-inside text-gray-700 space-y-2">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              <div className="p-8">
                <div className="flex items-center mb-6">
                  <IconWrapper icon={Palette} className="w-8 h-8 text-purple-600 mr-3" />
                  <h3 className="text-2xl font-bold text-purple-900">UI/UX Design Track</h3>
                </div>
                <div className="space-y-6">
                  <div>
                    <h4 className="text-xl font-semibold text-purple-900 mb-2">Course Duration</h4>
            ...
            <div className="lg:col-span-2 text-center mt-8">
              ...
              <p className="text-gray-700">
                Limited time offer for Secondary School graduates and JAMB candidates in Lagos
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-gradient-to-r from-purple-900 to-purple-700 py-16 px-4" id="orientation">
        <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  <IconWrapper icon={MapPin} className="w-8 h-8 text-purple-600" />
                  <div>
                    <h3 className="text-xl font-semibold text-purple-900">Venue</h3>
                    <p className="text-gray-700">University of Lagos</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  <IconWrapper icon={Calendar} className="w-8 h-8 text-purple-600" />
                  <div>
                    <h3 className="text-xl font-semibold text-purple-900">Important Dates</h3>
              ...
              <div className="bg-purple-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-purple-900 mb-4">What to Expect</h3>
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start">
                    <span className="bg-purple-200 rounded-full p-1 mr-3 mt-1">
                      <IconWrapper icon={Users} className="w-4 h-4 text-purple-700" />
                    </span>
                    Meet your instructors and fellow students
                  </li>
                  <li className="flex items-start">
                    <span className="bg-purple-200 rounded-full p-1 mr-3 mt-1">
                      <IconWrapper icon={BookOpen} className="w-4 h-4 text-purple-700" />
                    </span>
                    Program overview and curriculum walkthrough
                  </li>
                  <li className="flex items-start">
                    <span className="bg-purple-200 rounded-full p-1 mr-3 mt-1">
                      <IconWrapper icon={Globe} className="w-4 h-4 text-purple-700" />
                    </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="hover:text-purple-300">Curriculum</a></li>
